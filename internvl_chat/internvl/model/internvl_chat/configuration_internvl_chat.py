...
class InternVLChatConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        logger.info(f'use_scene_det: {self.use_scene_det}')
        ...
        logger.info(f'is freeze ffc: {self.freeze_ffc}')
        logger.info(f'is ffc use multi_scale: {self.use_multi_scale}')
        logger.info(f'is ffc through selector: {self.use_selector}')
    ...
    def to_dict(self):
        ...
        output['use_scene_det'] = self.use_scene_det
        output['use_video_frames_compress'] = self.use_video_frames_compress
        output['freeze_ffc'] = self.freeze_ffc
        ...
        output['use_multi_scale'] = self.use_multi_scale
        output['use_selector'] = self.use_selector
